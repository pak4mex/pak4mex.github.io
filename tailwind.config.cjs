    ...
    extend: {
      ...
      keyframes: theme => ({
        activityIndicatorTop: {
          ...
          '24.99%': {transform: 'translate(0,0)', 'background-color': theme('colors.bosch-red-50')},
          '25%': {'background-color': theme('colors.bosch-blue-50')},
          '37.5%': {transform: 'translate(0, 100%)'},
          '50%': {transform: 'translate(0,0)'},
          '62.5%': {transform: 'translate(100%,0)'},
          '74.99%': {transform: 'translate(0,0)', 'background-color': theme('colors.bosch-blue-50')},
          '75%': {'background-color': theme('colors.bosch-red-50')},
          '87.5%': {transform: 'translate(0,100%)'},
          '100%': {transform: 'translate(0,0)'},
        },
        activityIndicatorBottom: {
          '0%': {transform: 'translate(0,0)', 'background-color': theme('colors.bosch-purple-50')},
          '12.5%': {transform: 'translate(-100%,0)', 'z-index': 2},
          '25%': {transform: 'translate(0,0)', 'z-index': 2},
          '37.5%': {transform: 'translate(0, -100%)', 'z-index': 0},
          '49.99%': {transform: 'translate(0,0)', 'z-index': 0, 'background-color': theme('colors.bosch-purple-50')},
          '50%': {'background-color': theme('colors.bosch-green-50')},
          '62.5%': {transform: 'translate(-100%,0)', 'z-index': 2},
          '75%': {transform: 'translate(0,0)', 'z-index': 2},
          '87.5%': {transform: 'translate(0,-100%)'},
          '99.99%': {'background-color': theme('colors.bosch-green-50')},
          '100%': {transform: 'translate(0,0)', 'background-color': theme('colors.bosch-purple-50')},
        }
      }),
      animation: {
        'activity-indicator-top-box': 'activityIndicatorTop 3s ease-in-out infinite',
        'activity-indicator-bottom-box': 'activityIndicatorBottom 3s ease-in-out infinite'
      },
      borderWidth: {
        '1': '1px',
      }
